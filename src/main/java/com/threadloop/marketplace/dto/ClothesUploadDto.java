...
public class ClothesUploadDto {
    ...
    public Integer getOwnerSwapsCount() {
        return ownerSwapsCount;
    }

    public void setOwnerSwapsCount(Integer ownerSwapsCount) {
        this.ownerSwapsCount = ownerSwapsCount;
    }
